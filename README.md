> **Deployed FR3/WMRL snapshot:** Start with [CONTROLLER_MISMATCH_HANDOVER.md](CONTROLLER_MISMATCH_HANDOVER.md) for exact provenance, controller differences and offline rollout analysis.
